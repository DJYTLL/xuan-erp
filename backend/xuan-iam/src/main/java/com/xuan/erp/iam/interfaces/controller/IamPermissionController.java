...
public class IamPermissionController {
    ...
    @PreAuthorize("@xuanPermission.has('iam-permission:view')")
    @GetMapping
    ...
    @PreAuthorize("@xuanPermission.has('iam-permission:create')")
    @PostMapping
    ...
    @PreAuthorize("@xuanPermission.has('iam-permission:update')")
