---
title: "xuan-sales 数据库结构"
---

本文记录 `xuan-sales` 的数据库结构、表字段、索引、约束、初始化数据和 Flyway migration 对应关系。
...
| migration 目录 | `xuan-sales/src/main/resources/db/migration/` |
| 数据所有权 | 只允许 `xuan-sales` 直接写入 |
