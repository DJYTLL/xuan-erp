      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'Sentinel 准备', slug: 'guide/sentinel-setup' },
            { label: 'Seata 准备', slug: 'guide/seata-setup' },
            { label: 'Redis 与 Elasticsearch 准备', slug: 'guide/cache-search-setup' },
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'OpenAPI 与 springdoc-openapi', slug: 'backend/openapi-springdoc' },
        ...
        },
        {
          label: '服务数据库结构',
          items: [
            { label: 'xuan-gateway 数据库', slug: 'backend/services/xuan-gateway/database' },
            { label: 'xuan-iam 数据库', slug: 'backend/services/xuan-iam/database' },
            { label: 'xuan-tenant 数据库', slug: 'backend/services/xuan-tenant/database' },
            { label: 'xuan-product 数据库', slug: 'backend/services/xuan-product/database' },
            { label: 'xuan-party 数据库', slug: 'backend/services/xuan-party/database' },
            { label: 'xuan-warehouse 数据库', slug: 'backend/services/xuan-warehouse/database' },
            { label: 'xuan-sales 数据库', slug: 'backend/services/xuan-sales/database' },
            { label: 'xuan-procurement 数据库', slug: 'backend/services/xuan-procurement/database' },
            { label: 'xuan-inventory 数据库', slug: 'backend/services/xuan-inventory/database' },
            { label: 'xuan-manufacturing 数据库', slug: 'backend/services/xuan-manufacturing/database' },
            { label: 'xuan-finance 数据库', slug: 'backend/services/xuan-finance/database' },
            { label: 'xuan-document 数据库', slug: 'backend/services/xuan-document/database' },
            { label: 'xuan-audit 数据库', slug: 'backend/services/xuan-audit/database' },
            { label: 'xuan-query 数据库', slug: 'backend/services/xuan-query/database' },
          ],
        },
        {
          label: '前端接入',
        ...
        },
        {
          ...
          items: [
            ...
            { label: 'duaoyunxuan.com 中间件端口', slug: 'ops/middleware-ports' },
            { label: '域名与反向代理待办', slug: 'ops/domain-reverse-proxy' },
            { label: '备份与恢复', slug: 'ops/backup-restore' },
            { label: 'NAS Docker 代理配置', slug: 'ops/nas-docker-proxy' },
